...
def parse_args():
    ...
    parser.add_argument('--config', default='./CFINet/faster_rcnn_r50_fpn_cfinet_1x.py',help='test config file path')
    parser.add_argument('--checkpoint',default='./CFINet/latest.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
        default='./CFINet1',
